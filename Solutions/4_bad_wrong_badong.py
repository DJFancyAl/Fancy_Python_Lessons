...
First of all - add a movie to the movies dictionary, but don't add it directly to the movies dictionary. All of your code must be below the comment line.
Then all you have to do is iterate through movies and for each move print "The best line in <<movie>> is <<quote>>."
...
movies['Joe Dirt'] = [2001, "Life's a garden, dig it."]

for key, val in movies.items():
    print(f"\nThe best line in {key} is {val[1]}")